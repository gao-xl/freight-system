...
const routes = [
  ...
  { path: '/onboarding', name: 'onboarding', component: () => import('@/views/onboarding/OnboardingWizard.vue'), meta: { title: '快速开始' } },
  {
    ...
    children: [
      ...
      { path: 'hs-codes', name: 'hsCodes', component: () => import('@/views/customs/HsCodeSearch.vue'), meta: { title: 'HS编码库', icon: 'Collection', permission: 'customs:read' } },
      ...
      { path: 'finance/aging', name: 'agingAnalysis', component: () => import('@/views/finance/AgingAnalysis.vue'), meta: { title: '应收账龄', icon: 'TrendCharts', permission: 'finance:read' } },
      { path: 'finance/budget', name: 'budget', component: () => import('@/views/finance/BudgetList.vue'), meta: { title: '预算管理', icon: 'PieChart', permission: 'budget:read' } }, // P3-2
      { path: 'finance/debit-notes', name: 'debitNotes', component: () => import('@/views/finance/DebitNoteList.vue'), meta: { title: '借记通知单', icon: 'Document', permission: 'finance:read' } },
      { path: 'finance/bills-of-lading', name: 'billsOfLading', component: () => import('@/views/finance/BillOfLadingList.vue'), meta: { title: '提单管理', icon: 'Ship', permission: 'order:read' } },
      { path: 'finance/reconciliation', name: 'reconciliation', component: () => import('@/views/finance/ReconciliationDashboard.vue'), meta: { title: '对账工作台', icon: 'DataAnalysis', permission: 'finance:read' } },
      ...
      { path: 'quotation-templates', name: 'quotationTemplates', component: () => import('@/views/quotations/QuotationTemplateList.vue'), meta: { title: '报价模板', icon: 'Tickets', permission: 'quotation:read' } },
      ...
      { path: 'system/monitor', name: 'opsMonitor', component: () => import('@/views/system/OperationsMonitor.vue'), meta: { title: '运维监控', icon: 'Monitor', permission: 'system:user' } }, // P3-3
